...
public class Axes {
    ...
    public void makeAxes(float size) {
        ...
        float[] index = new float[vertexs.length];
        for(i=0;i<vertexs.length;i++){
            index[i] = -1.0f;
            //System.out.println("ind:"+index[i]);
        }
        indBuffer = BufferUtil.makeFloatBuffer(index);
    }
    ...
    public void draw(float r,float g,float b,float a, float shininess, float linewidth){
        ...
        GLES20.glVertexAttribPointer(GLES.indexHandle, 1, GLES20.GL_INT, false, 0, indBuffer);
        ...
        //shadingを使わない時に使う単色の設定 (r, g, b,a)
        GLES20.glUniform4f(GLES.objectColorHandle, 1f, 0, 0, a);
        ...
        //shadingを使わない時に使う単色の設定 (r, g, b,a)
        GLES20.glUniform4f(GLES.objectColorHandle, 0, 1f, 0, a);
        ...
        //shadingを使わない時に使う単色の設定 (r, g, b,a)
        GLES20.glUniform4f(GLES.objectColorHandle, 0, 0, 1f, a);
